...
class ProductPage(BasePage):
    ...
    def should_be_add_this_book(self, name_book):
        assert name_book == self.browser.find_elements(*ProductPageLocators.BOOK_ADDED_TO_BASKET)[0].text, "Add wrong book"

    def should_be_add_true_price(self, price_book):
        assert price_book == self.browser.find_elements(*ProductPageLocators.BOOK_ADDED_TO_BASKET)[2].text, "Add wrong price book"